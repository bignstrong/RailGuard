        ...
        <Section>
          ...
          <SpecsColumn>
            <BasicCard>
              ...
              <RichText>
                <ul>
                  <li>Менять фильтрующий элемент RailGuard одновременно с основным топливным фильтром при каждом ТО.</li>
                  <li>Устанавливать чётко по стрелке, указывающей направление потока топлива.</li>
                  <li>Жёстко фиксировать корпус к двигателю, чтобы вибрация не повредила топливную магистраль.</li>
                </ul>
              </RichText>
